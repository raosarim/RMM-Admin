...
const navigationConfig: NavigationTree[] = [
    ...
    },
    {
        ...
        title: 'Landing Modes',
        translateKey: 'nav.landingModeItem',
        icon: 'singleMenu',
        type: NAV_ITEM_TYPE_ITEM,
        authority: [],
        subMenu: [],
    },
    {
        ...
        path: '/templates-view',
        title: 'Templates',
        translateKey: 'nav.templatesView',
        icon: 'singleMenu',
        type: NAV_ITEM_TYPE_ITEM,
        authority: [],
        subMenu: [],
    ...
    },
    {
        ...
        title: 'Subscription',
        translateKey: 'nav.subscriptionPackage',
        icon: 'singleMenu',
        type: NAV_ITEM_TYPE_ITEM,
        authority: [],
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.contactAndSupport',
        icon: 'singleMenu',
        type: NAV_ITEM_TYPE_ITEM,
        authority: [],
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.privacyAndPolicy',
        icon: 'singleMenu',
        type: NAV_ITEM_TYPE_ITEM,
        authority: [],
        subMenu: [],
